...
const {GetInfo,createPromotor,createVisita,deleteVisitaById,getPromotor,getVisitas,createRuta,getRuta,getVisita,updateVisita} = require('../controller/promotor')
...
router.route('/visita/:id').delete(deleteVisitaById)
