        ...
        return(
            <>
                ...
                <Form.Select  name='nombreTienda' >
                  {tienda.map((t) => {
                    return(<option key={d.nombreTienda} name='canal'>{t.nombreTienda}</option>)
                  })}
                </Form.Select>
                ...
                <Form.Group className="mb-3" >
                  ...
                  {tienda.map((t) => {
                    return(<option key={d.TDA} name='canal'>{t.TDA}</option>)
                  })}
                </Form.Select>
                <Form.Text className="font-weight-bold">
                    TDA
...
function CrearTienda({user}) {
  const handleSubmit = async (e) => {
      ...
      const data = {
        ...
        nivelSocioeconomico:e.target.socioe.value,
        region: e.target.region.value,
        distribucionP:e.target.distribucionP.value,
        distribucionS:e.target.distribucionS.value,
...
return (
  ...
  <h2 className='text-dark text-center'>Datos</h2>
    ...
    <Form.Group className="mb-3">
      ...
      <Form.Group className="mb-3">
        <Form.Label  className='text-dark'>Nivel Socioeconomico</Form.Label>
        <Form.Select name='socioe' >
          <option>Vacío</option>
          <option>Uno</option>
          <option>Dos</option>
          <option>Tres</option>
      ...
      <Form.Group className="mb-3">
        <Form.Label  className='text-dark'>Distribucion Primaria</Form.Label>
        <Form.Select name='distribucionP'>
      ...
      <Form.Group className="mb-3">
        <Form.Label  className='text-dark'>Distribucion Secundaria</Form.Label>
        <Form.Select name='distribucionS'>
    ...
    />
        ...
        <Col sm={4} className='mb-3' style={{fontFamily:'tahoma',fontWeight:'bold',fontSize:'1.1rem'}}>
          ...
          <ListGroup.Item  className='bg-dark text-danger font-weight-bold'>Picking List</ListGroup.Item>
            <ListGroup.Item action onClick={()=> setproducto(true)} variant="secondary">
            Crear picking list
            </ListGroup.Item>
            <ListGroup.Item action onClick={()=> setproducto(true)} variant="secondary">
